...
<section aria-labelledby="explore-title">
  <p class="section-kicker home-kicker">Explore</p>
  ...
  <div class="feature-grid">
    ...
    <article class="card"><span class="tag">Blogs</span><h3>What Is Data Science to Me?</h3><p>A personal introduction to my background, interests, and goals.</p><p><a href="{{ '/blog1.html' | relative_url }}">Read the post →</a></p></article>
  </div>
</section>

<section aria-labelledby="connect-title">
  <p class="section-kicker home-kicker">Connect</p>
